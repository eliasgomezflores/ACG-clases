...
//aqui estan lospuntos medios
 ...
 glColor3f(0.0, 1.0, 0.0);
      ...
      glEnd();
   // vari = {
   //    ((1-u) * ctrlpoints[0][0] - u * ctrlpoints[1][0], (1-u) * ctrlpoints[0][1] + u * ctrlpoints[1][1])),
   //    ((1-u) * ctrlpoints[1][0] + u * ctrlpoints[2][0], (1-u) * ctrlpoints[1][1] + u * ctrlpoints[2][1]),
   //    ((1-u) * ctrlpoints[2][0] + u * ctrlpoints[3][0], (1-u) * ctrlpoints[2][1] + u * ctrlpoints[3][1]),
...
//start del último punto
glColor3f(1.0, 0.0, 0.0);
   glMap1f(GL_MAP1_VERTEX_3, 0.0, 1.0, 3, 4, &ctrlpoints[0][0]);
   glEnable(GL_MAP1_VERTEX_3);
     glColor3f(1.0, 1.0, 0.4);// es la u
      glBegin(GL_POINTS);
      glEvalCoord1f(u);
   glEnd();
  //end del último punto
