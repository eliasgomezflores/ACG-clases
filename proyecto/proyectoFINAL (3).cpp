...
void nube(){
			 ...
			 glVertex3f(13, 27.5, 0);
			 glVertex3f(-40, 27.5, 0);
			 glEnd();
}
...
void dibuja(){
	...
	glTranslatef( 0, -47.5, 0 );	
		     ...
		     /*
 			 En esta matriz se dibuja el sol
 			 */
			 glPushMatrix();
			 glScalef(0.5,0.5,0);
			 glScalef(0.8,0.8,0);
			 ...
			 /*
			 En esta matriz se dibuja la nube
			 */	 
			 glPushMatrix();
			 glScalef(0.5,0.5,0);
			 ...
			 /*
			 En esta matriz se dibuja el pasto de la flor
			 */ 
			 controlPoints[0][0]=3;
			 controlPoints[0][1]=-5;
			...
			*/ 
			 ...
			 */
			 ...
			 glPopMatrix();
 			 ...
 			 /*
 			 En esta matriz se dibuja el circulo de la flor
 			 */
			 glPushMatrix();
			 glColor3f(1.0, 1.0, 0.0);
			 glBegin(GL_POLYGON);
