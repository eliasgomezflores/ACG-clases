...
int main(int argc, char *argv[])
{
    ...
    printf("	Tecla Flecha Derecha : Giro Horario de la Luna\n");
    printf("	Tecla Flecha Isquierda : Giro Antihorario de la Luna\n");
    glutInit(&argc, argv);
